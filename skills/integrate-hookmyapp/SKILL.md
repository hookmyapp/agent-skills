...
`hookmyapp channels env <channel> --write` mints a fresh gateway `hmat_` access token and writes the six WhatsApp keys your app reads directly (no hand-mapping needed):
